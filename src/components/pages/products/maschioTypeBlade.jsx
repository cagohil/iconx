...
import MaschioTypeBlade from "../../../assests/Maschio-type.jpg";
import {
  Box,
  Typography,
  List,
    ...
    <Box sx={{ my: 1 }}>
      ...
      <Grid container spacing={3} justifyContent="center" sx={{ mt: 2 }}>
        ...
        <Grid item xs={12} md={6} display="flex" flexDirection="column" alignItems="center" textAlign="center">
          <img
            src={MaschioTypeBlade}
            alt="Maschio-Type Blade"
        ...
        <Grid item xs={12} md={6} display="flex" flexDirection="column" justifyContent="center">
          <Typography variant="h5" fontWeight="bold" gutterBottom color="#156CB5">
            Characteristics
          </Typography>
